...
sudo echo "alias x728off='sudo x728softsd.sh'" >> /home/openhabian/.bashrc
...
#Set battery low voltage to shut down, you can modify the 3.00 to other value
 ...
 time.sleep(2)
' >> /home/openhabian/x728bat.py
#sudo chmod +x /home/openhabian/x728bat.py
...
while True:
    ...
    time.sleep(1)
' > /home/openhabian/x728pld.py
#sudo chmod +x /home/openhabian/x728pld.py
